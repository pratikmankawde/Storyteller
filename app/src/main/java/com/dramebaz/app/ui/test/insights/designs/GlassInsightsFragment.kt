 ...
 * Frosted glass effect cards with blur and transparency.
 */
class GlassInsightsFragment : BaseInsightsDesignFragment() {

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        return inflater.inflate(R.layout.fragment_insights_design_glass, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        view.findViewById<TextView>(R.id.reading_ease_value)?.text = "${dummyReadingLevel.readingEaseScore.toInt()}"
        ...
        view.findViewById<ChipGroup>(R.id.themes_chip_group)?.apply {
            ...
            dummyThemes.forEach { theme ->
                addView(Chip(requireContext()).apply {
                    text = theme
                    isClickable = false
                    setChipBackgroundColorResource(R.color.glass_chip_bg)
