...
### TTS: VITS-Piper en_US-libritts-high (Sherpa-ONNX)
...
**Workarounds:**
1. **Pitch variation:** Use different speaker IDs (categorize 904 speakers by pitch level)
2. **Volume control:** Post-process audio samples (multiply by energy scale)
