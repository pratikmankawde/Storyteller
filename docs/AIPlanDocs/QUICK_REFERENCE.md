...
### Modular TTS Pipeline (Updated 2026-02-06)
✅ **ARCHITECTURE:**
...
**Available Models:**
| Model | Speakers | Sample Rate |
|-------|----------|-------------|
| LibriTTS-904 | 904 voices | 22050 Hz |
| Kokoro v0.19 | 10 voices | 24000 Hz |

**Switching Models:**
```kotlin
sherpaTtsEngine.switchModel("kokoro-en-v0.19")
// or edit tts_model_config.json
```

### VITS-Piper TTS (LibriTTS)
✅ **CAN DO:**
- 904 speakers (LibriTTS)
- Speed 0.5-2.0x
- High quality
